...
c.colors.tabs.bar.bg = dragonBlue # '#555555'
...
c.colors.tabs.even.bg = lotusTeal1
...
c.colors.tabs.even.fg = fujiWhite
...
c.colors.tabs.odd.bg = lotusTeal3
...
c.colors.tabs.odd.fg = fujiWhite
...
c.colors.tabs.pinned.even.fg = fujiWhite
...
c.colors.tabs.pinned.odd.fg = fujiWhite
...
c.colors.tabs.pinned.selected.even.fg = fujiWhite
...
c.colors.tabs.pinned.selected.odd.fg = fujiWhite
...
c.colors.tabs.selected.even.bg = waveAqua2
...
c.colors.tabs.selected.odd.bg = waveAqua1
...
c.editor.command = ['glrnvim', '-f', '{file}', '-c', 'normal {line}G{column0}l']
...
c.fonts.web.family.fixed = 'Input'
...
c.fonts.web.family.sans_serif = 'Andika'
...
c.fonts.web.family.serif = 'Gentium'
...
c.qt.force_platformtheme = 'Breeze'
